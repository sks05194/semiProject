 ...
 * @author 임성현
 * 
 * 주요 수정 내용: 비교를 위한 m_name, d_m_name, m_position 추가 (테이블에 존재하지 않음)
 */
...
public class DocumentVO {
	...
	private int m_no = 0;			// 결재 작성자 : 작성자 사번
	private int d_m_no = 0;			// 결재 승인자 : 승인자 사번
	private String d_content = null;	// 결재 내용
	private String d_request = null;	// 결재 작성일
	private String d_response = null;	// 결재 승인일
	private String m_name = null; // 결재 작성자 : 작성자 이름
	private String d_m_name = null; // 결재 승인자 : 승인자 이름
