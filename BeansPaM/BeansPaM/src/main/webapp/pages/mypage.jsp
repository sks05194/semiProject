	...
	<main>
		...
		<div id="editInfoModal" class="modal">
			<div class="modal-content">
				...
				<h2>회원정보 수정</h2>
				<form id="editInfoForm" action="updateMember" method="post"
					onsubmit="return validateForm()">
					<label for="email">이메일:<small>형식: example@example.com</small></label> <input type="text"
						id="email" name="email" value="<%=mvo.getM_email()%>"><br>

					<br> <label for="phone">전화 번호:<small>형식: 010-1234-5678</small></label> <input
						type="text" id="phone" name="phone" value="<%=mvo.getM_phone()%>"><br>
		...
		<div id="changePwdModal" class="modal">
			<div class="modal-content">
				...
				<form id="changePwdForm" action="changePassword" method="post"
					onsubmit="return validatePasswordForm()" data-mpw="<%= mvo.getM_pw() %>">
					<label for="oldPwd">현재 비밀번호:</label>
					<input type="password" id="oldPwd" name="oldPwd" placeholder="현재 비밀번호를 입력하세요."><br>

					<br><br>

					<label for="newPwd">새 비밀번호:</label>
					<input type="password" id="newPwd" name="newPwd"
						placeholder="새 비밀번호는 최소 5자리 이상이어야 합니다."><br>

					<br><br>

					<label for="confirmPwd">비밀번호 확인:</label>
					<input type="password" id="confirmPwd" name="confirmPwd"
						placeholder="새 비밀번호와 동일하게 입력하세요."><br>
