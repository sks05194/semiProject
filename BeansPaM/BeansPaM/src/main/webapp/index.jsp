...
<body>
    <main>
        ...
        <section id="about">
            <h2>About Us</h2>
            <p>At BeansPaM, we are passionate about sourcing the highest quality coffee beans from ethical and sustainable farms. Each bean is handpicked and roasted to perfection to give you the best coffee experience.</p>
        </section>
